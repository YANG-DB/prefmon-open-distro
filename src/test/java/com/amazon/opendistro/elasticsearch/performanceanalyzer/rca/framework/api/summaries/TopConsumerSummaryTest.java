...
public class TopConsumerSummaryTest {
    ...
    public void testGetSqlSchema() {
        ...
        Assert.assertEquals(SQL_SCHEMA_CONSTANTS.CONSUMER_NAME_COL_NAME, nameField.getName());
        Assert.assertEquals(String.class, nameField.getType());
        Assert.assertEquals(SQL_SCHEMA_CONSTANTS.CONSUMER_VALUE_COL_NAME, valueField.getName());
