...
public class CacheClearActionTest {
  ...
  public void setupClusterDetails() {
    ...
    NodeDetails node1 =
        new NodeDetails(NodeRole.DATA, "node1", "127.0.0.0", false);
    NodeDetails node2 =
        new NodeDetails(NodeRole.DATA, "node2", "127.0.0.1", false);
    NodeDetails master =
        new NodeDetails(NodeRole.ELECTED_MASTER, "master", "127.0.0.3", true);
