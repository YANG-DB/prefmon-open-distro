...
public class InstanceDetails {
  ...
  public InstanceDetails(NodeRole role, Id instanceId, Ip instanceIp, boolean isMaster) {
    this(role, instanceId, instanceIp, isMaster, PluginSettings.instance().getRpcPort());
  }

  public InstanceDetails(NodeRole role, Id instanceId, Ip instanceIp, boolean isMaster, int grpcPort) {
    this.role = role;
  ...
  public InstanceDetails(ClusterDetailsEventProcessor.NodeDetails nodeDetails) {
    this(NodeRole.valueOf(nodeDetails.getRole()),
