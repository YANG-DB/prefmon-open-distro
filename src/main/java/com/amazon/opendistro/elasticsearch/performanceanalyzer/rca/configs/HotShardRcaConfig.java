...
public class HotShardRcaConfig {
    ...
    public HotShardRcaConfig(final RcaConf rcaConf) {
        ...
        ioTotSysCallRateThreshold = rcaConf.readRcaConfig(CONFIG_NAME,
                RCA_CONF_KEY_CONSTANTS.IO_TOT_SYSCALL_RATE_THRESHOLD_PER_SECOND,
